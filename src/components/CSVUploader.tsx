...
export const CSVUploader: React.FC<CSVUploaderProps> = ({ onLocationsLoaded, compact = false }) => {
  ...
  if (compact) {
    return (
      <label className="flex h-8 cursor-pointer items-center justify-center rounded-md bg-blue-600 px-3 text-xs font-semibold text-white shadow-sm hover:bg-blue-700">
        CSV
        <input
          type="file"
          accept=".csv"
